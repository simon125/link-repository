    ...
    <nav class="bg-gray-800">
      <div class="max-w-7xl mx-auto px-2 sm:px-6 lg:px-8">
        <div class="relative flex items-center justify-between h-16">
          ...
          <div class="flex-1 flex items-center content-center justify-center sm:items-stretch sm:justify-start">
            <div class="flex-shrink-0">
              <h1 className="text-gray-100 text-center">Link repository</h1>
            </div>
